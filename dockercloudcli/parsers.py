...
def add_exec_parser(subparsers):
    ...
    exec_parser.add_argument('identifier', help="The container's UUID (either long or short) or name")
...
def add_stack_parser(subparsers):
    ...
    create_parser.add_argument('-n', '--name', help='The name of the stack shown in Docker Cloud')
